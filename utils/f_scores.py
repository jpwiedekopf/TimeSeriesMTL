...
# ==============================================================================
# Implementation from: https://raw.githubusercontent.com/tensorflow/addons/r0.5/tensorflow_addons/metrics/f_scores.py

"""Implements F_beta scores."""
...
class F2Score(FBetaScore):
    def __init__(self, num_classes, average, name='f2_score',
                 dtype=tf.float32):
        super(F2Score, self).__init__(
            num_classes, average, 2.0, name=name, dtype=dtype)

    def get_config(self):
        base_config = super(F2Score, self).get_config()
        del base_config["beta"]
        return base_config
